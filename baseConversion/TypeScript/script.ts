...
try { console.log(baseConversion(-1, ["1"])); } catch (error) { console.log(error); }
try { console.log(baseConversion(0.1, ["1"])); } catch (error) { console.log(error); }
try { console.log(baseConversion(Infinity, ["0", "1"])); } catch (error) { console.log(error); }
try { console.log(baseConversion((0 / 0), ["1"])); } catch (error) { console.log(error); }
